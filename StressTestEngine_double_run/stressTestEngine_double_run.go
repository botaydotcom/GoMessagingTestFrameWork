package StressTestEngine_simplify
...
func PerformTestCaseTwice(addr *net.TCPAddr, testCase *TestCase, listMessage [][]byte) (TestResult){
	var result = TestResult{
		IsCorrect: true,
		Reason:    nil,
		TimeTaken: 0,
...
func sendArchivedMsg([]byte archivedMessage, conn *net.TCPConn) {
	n, err := conn.Write(archivedMessage)
}
