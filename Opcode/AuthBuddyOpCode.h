...
namespace AUTHS2C
{
	namespace BuddyOpCode
	{
		enum
		{
			...
			RemoteAddServiceResult_CMD = 0x85,
			RemoteRemoveServiceResult_CMD = 0x86,
			MyServiceResult_CMD  = 0x87,
			RemoteAddServiceRequest_CMD = 0x88,
			RemoteRemoveServiceRequest_CMD = 0x89,
		};
	}
}
...
namespace AUTHC2S
{
	namespace BuddyOpCode
	{
		enum
		{
			...
			AddService_CMD = 0x84,
			RemoveService_CMD = 0x85,
			MyServiceQuery_CMD = 0x86,
			AddServiceResult_CMD = 0x87,
			RemoveServiceResult_CMD = 0x88,
		};
	}
}
#endif